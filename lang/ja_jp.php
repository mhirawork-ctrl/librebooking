...
class ja_jp extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        $strings['ScheduleCalendar'] = '時間割ビュー';
        ...
        $strings['GroupName'] = '研究室名';
        $strings['GroupMembers'] = '研究室メンバー';
        ...
        $strings['Phone'] = '電話';
        $strings['PhoneRequired'] = '電話番号は必須です。';
        $strings['Organization'] = '所属';
        $strings['Position'] = '役職';
        $strings['Language'] = '言語';
        $strings['Permissions'] = '権限';
        $strings['Reset'] = 'リセット';
        $strings['FindGroup'] = '研究室を探す';
        $strings['Manage'] = '管理';
        $strings['None'] = 'なし';
        ...
        $strings['ViewSchedule'] = '時間割ビューを見る';
        ...
        $strings['UsersInGroup'] = 'この研究室のユーザー';
        $strings['Browse'] = '表示';
        $strings['DeleteGroupWarning'] = '研究室を削除すると研究室に付与していた権限も削除されます。この研究室のユーザーが会議室にアクセスできなくなることがあります。';
        $strings['WhatRolesApplyToThisGroup'] = 'この研究室の役割';
        $strings['WhoCanManageThisGroup'] = 'この研究室の管理者';
        ...
        $strings['DeleteResourceWarning'] = 'この会議室を削除すると関連する次のものを含む全てのデータも削除されます。';
        $strings['DeleteResourceWarningReservations'] = '当会議室の全ての予約';
        $strings['DeleteResourceWarningPermissions'] = '当会議室の全ての権限の割り当て';
        ...
        $strings['MoveResourcesAndReservations'] = '会議室と予約を移動';
        ...
        $strings['WhoCanManageThisResource'] = 'この会議室の管理権限を誰に付与しますか？';
        $strings['ResourceAdministrator'] = '会議室管理者';
        ...
        $strings['Custom'] = 'カスタム';
        $strings['AddDate'] = '日付を追加';
        $strings['RepeatOn'] = '繰り返す曜日';
        $strings['Owner'] = '予約者';
        $strings['MaximumConcurrentReservations'] = '同時予約の上限';
        $strings['NotifyUsers'] = 'ユーザーに通知';
        ...
        $strings['ResourceCalendar'] = '月間カレンダー';
        ...
        $strings['ApplicationManagement'] = 'システム管理';
        $strings['CheckResources'] = '会議室一覧';
        $strings['CheckSchedules'] = '時間枠一覧';
